...
/*   Updated: 2021/07/18 19:41:10 by rbourgea         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
std::ostream &operator<<(std::ostream &o, Form const &i)
{
	...
	if (i.getSigned() == true)
		o << "]," << GREEN BOLD << " has been signed ✔︎" << RESET << std::endl;
	else
...
void Form::execute(Bureaucrat const &executor) const
{
	...
	else if (_Signed == true && executor.getGrade() > _Grade_Required_To_Execute)
		throw grade_too_low_exception;
}

std::ostream &Form::output(std::ostream &o) const
{
	o << *this;
	return (o);
}
